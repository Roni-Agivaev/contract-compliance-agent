...
_EXAMPLE_STEPS = [
    ...
    {
        "module": "Company Law",
        "prompt": {"System_prompt": "[ComplianceRetriever] query US FLSA namespace + ILO baseline.",
                    "User_prompt": "Queries: minimum wage Germany | notice period termination BGB | ..."},
        "response": {"retrieved": [{"source": "US Fair Labor Standards Act (FLSA)", "section": "§206", "score": 0.41}]},
    },
    {
        "module": "Company Law",
        "prompt": {"System_prompt": "[MinimumWageTool] Supabase lookup of 2026 minimum wage.",
                    "User_prompt": "country=United States"},
        "response": {"found": True, "country": "United States", "amount": 7.25, "currency": "USD", "unit": "hour"},
    },
    {
        "module": "Company Law",
        ...
        "response": {"jurisdiction": "United States", "breaches": []},
    },
    {
        "module": "Employee Law",
        "prompt": {"System_prompt": "[ComplianceRetriever] query German BGB namespace + ILO baseline.",
                    "User_prompt": "Queries: minimum wage Germany | notice period termination BGB | ..."},
        "response": {"retrieved": [{"source": "German Civil Code (BGB)", "section": "§622", "score": 0.63}]},
    },
    {
        "module": "Employee Law",
        "prompt": {"System_prompt": "[MinimumWageTool] Supabase lookup of 2026 minimum wage.",
                    "User_prompt": "country=Germany"},
        "response": {"found": True, "country": "Germany", "amount": 12.82, "currency": "EUR", "unit": "hour"},
    },
    {
        "module": "Employee Law",
        ...
        "response": {"jurisdiction": "Germany", "breaches": [
